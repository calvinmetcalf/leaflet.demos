...
we create an object called public and and attach it to the window, we then put the layers and data in it. I don't normally do this, but today I made an exception so you can open the developer tools (chrome ctr+shift+i, IE f12, firefox ctrl+shift+k) and look at this stuff.  Now [go play with the map we made.](http://calvinmetcalf.github.com/leaflet.demos)
